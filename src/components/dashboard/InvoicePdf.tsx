      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.mainGrid}>
          <View style={styles.customerSection}>
            ...
            <Text style={styles.customerName}>{invoice.customer?.name || 'N/A'}</Text>
            <Text style={styles.customerText}>{invoice.customer?.state || ''}</Text>
          </View>
          <View style={styles.projectSection}>
            <Text style={styles.sectionLabel}>Project Reference</Text>
            <Text style={[styles.customerName, { fontSize: 11 }]}>{invoice.project?.name || 'N/A'}</Text>
